...
public class AttachmentController {
    ...
    public AttachmentController(StorageService storageService, ChannelRepository channelRepository,
    ...
    public AttachmentResponse uploadAttachment(@PathVariable Long channelId, @RequestParam("file") MultipartFile file) {
        ...
        String url = storageService.upload(file, "chat/" + channelId);
    ...
    public FileAttachmentResponse uploadFile(@PathVariable Long channelId, @RequestParam("file") MultipartFile file) {
        ...
        StorageService.FileUploadResult result = storageService.uploadAttachment(file, "chat/" + channelId);
